Pod::Spec.new do |spec|
  ...
  spec.source                = { :git => "https://github.com/RobGasser/CloudClass-iOS.git", :tag => "AgoraEduUI_v" + "#{spec.version.to_s}" }
  spec.public_header_files   = "SDKs/AgoraEduUI/Classes/**/*.h"
  spec.source_files          = "SDKs/AgoraEduUI/Classes/**/*.{h,m,swift}"
  
  spec.dependency "AgoraUIBaseViews", "~>2.8.111"
  spec.dependency "AgoraEduCore", "~>2.8.111"
